...
**Live:** https://play.aaryaakamdar.com  ·  **Source:** github.com/aaryaa8/play-studies (private)

Redeploy after changes with `npx vercel@latest deploy --prod --yes` from this folder. Media for the portfolio page lives at stable URLs like `https://play.aaryaakamdar.com/assets/gifs/turn.mp4`, and `assets/embed-snippet.html` is a ready-to-paste WordPress block that uses them.
